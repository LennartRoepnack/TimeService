...
* Create Repository via following [URL](https://github.com/new)
  * Set repository name to TimeService 
...
* On your local system execute following commands in the project directory:
    ...
    git branch -M main
    git remote add origin https://github.com/LennartRoepnack/TimeService
    ```
...
*   [mavenBuild.yml](https://github.com/LennartRoepnack/TimeService/actions/workflows/mavenBuild.yml):
    *   __Description:__ Builds the project after each push
    *   __Started:__ Automatically and manually   

*   [newRelease.yml](https://github.com/LennartRoepnack/TimeService/actions/workflows/newRelease.yml):
...
*   [autoMerge.yml](https://github.com/LennartRoepnack/TimeService/actions/workflows/autoMerge.yml):
...
*   [dependabot.yml](https://github.com/LennartRoepnack/TimeService/actions/workflows/dependabot.yml):
...
```shell
docker stack deploy --compose-file ./deploy/docker-compose.yml timeservice
```
