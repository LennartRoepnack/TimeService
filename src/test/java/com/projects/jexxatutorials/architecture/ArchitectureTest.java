package com.projects.jexxatutorials.architecture;
...
class ArchitectureTest {
    ...
    {
        portsAndAdapters(TimeService.class)
                // Add all packages providing driven adapter
                .addDrivenAdapterPackage("display")
    ...
    {
        patternLanguage(TimeService.class).validate();
    }

    @Test
    void validateAggregateRules()
    {
        aggregateRules(TimeService.class).validate();
    }
}